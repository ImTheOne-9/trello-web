      ...
      <Box sx={{ paddingX: 2, my: 4 }}>
        <Grid container spacing={2}>
          ...
          <Grid size={{ xs: 12, sm: 9 }}>
            <Typography variant="h6" sx={{ fontWeight: 'bold', mb: 2 }}>YOUR WORKSPACES:</Typography>
            ...
            {boards?.length > 0 &&
              <Grid container spacing={2}>
                {boards.map(b =>
                  <Grid size={{ xs: 12, sm: 6, md: 3.5 }} key={b._id}>
                    <Box
                      component={Link}
                      to={`/boards/${b?._id}`}>
                      <Card sx={{ width: '300px' }}>
                        {/* Ý tưởng mở rộng về sau làm ảnh Cover cho board nhé */}
                        <CardMedia component="img" height="100" image="https://lienminhhomes.vn/watermark/news/900x540x1/upload/news/gothic-architecture-la-gi-7283.jpg" />
